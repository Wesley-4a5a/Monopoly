...
function VakCheck()
{
    switch (vakje){
        ...
        case 5: case 15: case 25: case 35:
            if(Straten[vakje] == 0)
             {
            DisplayKoop("Wil je dit station kopen? 200.000 euries bruh.");
            KoopVis();
            }
            else
            {
        ...
        case 8:
            if(Straten[vakje] == 0)
            {
                DisplayKoop("Lyon: Lyon oder Lyoff?");
                KoopVis();
            }
            else
            {
        ...
        case 9:
            if(Straten[vakje] == 0)
            {
                DisplayKoop("Parijs: Eagles of deathmetal");
                KoopVis();
            }
            else
            {
        ...
        case 12: case 28:
            ...
            {
                DisplayKoop("Kerncentrale Dodewaard: Er zit toch jodium in zout");
                KoopVis();
            }
            else if((Straten[vakje] == 0) && (vakje == 28))
            {
                DisplayKoop("Fukushima: Chernobyl komt er niet eens dichtbij man. XD");
                KoopVis();
            }
            else
            {
        ...
        case 18:
            if(Straten[vakje] == 0)
            {
                DisplayKoop("Maarssen: R.I.P Alan.");
                KoopVis();
            }
            else
            {
        ...
        case 19:
            if(Straten[vakje] == 0)
            {
                DisplayKoop("Ypecolsga: Waar de hell is dit?");
                KoopVis();
            }
            else
            {
        ...
        case 23:
            if(Straten[vakje] == 0)
            {
                DisplayKoop("Barcelona: Bazalona");
                KoopVis();
            }
            else
            {
        ...
        case 37:
            if(Straten[vakje] == 0)
            {
                DisplayKoop("Conce.. Hoeryong: Hoerenjong");
                KoopVis();
            }
            else
            {
...
function HuisKopen(Prijs, Naam, Nummer)
{
    ...
    if (Straten[Nummer] == 5 && Eigenaar[Nummer] == CurPTurn){
        ...
        Straten[Nummer]++;
        LogHuis(Naam);
        var msg = "Hotelske gebouwt, Wat een baas."; 
